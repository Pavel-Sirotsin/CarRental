...
<fmt:message key="label.title.contact" var="titleContact"/>
...
<fmt:message key="label.tel" var="tel"/>
<fmt:message key="label.email" var="email"/>
<fmt:message key="label.address" var="address"/>
<fmt:message key="label.click" var="click"/>

<fmt:message key="command.contact.ref" var="contactRef"/>
...
<body style="background-image: url(img/background_city.jpg); background-size: cover; background-attachment: fixed; ">
    ...
    <header class="navbar navbar-light bg-secondary bg-gradient p-1">
        <nav class="container-fluid gap-2 d-flex justify-content-between">
            ...
            <ul class="nav nav-tabs col-md-auto col-lg-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link active text-danger" aria-current="page">${contact}</a>
                </li>
                <li class="nav-item">
            ...
            <div class="btn-group gap-2 col-md-auto col-lg-auto">
                <a href=${contactRef} class="btn btn-success rounded" aria-current="page">${lang}</a>
    ...
    <!--Main container-->
    <div class="container col-lg-6 p-2 mt-5 mb-5 p-3 text-white fs-5">
        <a href="https://www.google.ru/maps/@49.3713378,-0.8766986,13z" target="_blank">
            <img src="${pageContext.request.contextPath}/img/map.jpg" class="w-25 p-1 mb-1 rounded bg-white" alt="map img">
            <span class="position-absolute top-10 translate-middle badge rounded-pill bg-danger">
                ${click}
            </span>
        </a>
        <div class="p-2 bg-secondary bg-gradient border-start border-5 border-info rounded">
            <div class="ms-1">${tel}</div>
        ...
        <ul class="nav col-md-4 justify-content-end list-unstyled d-flex">
            <li class="ms-3">
                <a target="_blank " href="https://twitter.com/epam_belarus?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor ">
                    <img class="bi " width="24 " height="24 " src="${pageContext.request.contextPath}/img/twitter.png " />
                </a>
            </li>
            <li class="ms-3 ">
                <a target="_blank " href="https://www.instagram.com/epam.belarus/?hl=ru ">
                    <img width="24 " height="24 " src="${pageContext.request.contextPath}/img/instagram.png " />
                </a>
            </li>
            <li class="ms-3 ">
                <a target="_blank " href="https://www.facebook.com/EPAM.Belarus/ ">
                    <img class="bi " width="24 " height="24 " src="${pageContext.request.contextPath}/img/facebook.png " />
                </a>
            </li>
        </ul>
    </footer>
